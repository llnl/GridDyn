...
if(NOT MSVC)
    ...
    foreach(_sundials_target IN LISTS _all_targets)
        if(_sundials_target MATCHES "^sundials_")
            get_target_property(_sundials_target_type ${_sundials_target} TYPE)
            if(NOT _sundials_target_type STREQUAL "INTERFACE_LIBRARY")
