...
including `GENSAL`, `ESST4B`, and native `GGOV1`. Recognition alone is not compatibility: the existing
...
| `ESST4B`                                       | `ESST4B`                | `ExciterESST4B`                                                               | **Implemented.** Exact PSS/e field mapping, initialization, OpenIPSL bounded-integrator limits, potential-source rectifier, GENSAL coupling, residual, and analytic-Jacobian tests are present. External UEL/OEL inputs and a captured trajectory remain.                                                                                                                                                                                  |
...
| `GGOV1`                                        | `TGOV1`                 | `GovernorGgov1`                                                               | **Implemented natively.** GridDyn reads all 35 PSS/e parameters rather than reproducing ANDES's lossy TGOV1 conversion. Selectable droop, PID, three-way limiting, valve/turbine/temperature paths, machine-power coupling, initialization, and analytic Jacobians are covered. Nonzero `TENG` is rejected.                                                                                                                            |
...
24 model families. The current DYR reader recognizes 1,647 records (`GENROU`,
`IEEEST`, `EXAC2`, `IEEEG1`, `ESDC1A`, `EXAC1`, `GGOV1`, `ESST4B`, and
`GENSAL`); 1,058 records require
additional support.
...
`EXPIC1` (86), `HYGOV` (22), `IEEET1` (19), `USRMDL` (15),
...
families. The current DYR dispatch recognizes 29,904 records in `GENROU`,
`IEEEST`, `IEEEG1`, `ESDC1A`, `EXAC1`, `EXAC2`, `GGOV1`, `ESST4B`, and
`GENSAL`; 10,514 records remain unsupported. The highest-demand missing models are
`HYGOV` (2,306), `IEEET1` (1,907), and `SCRX`
