...
| `src/fileInput/readElement.h`                                    |   39 | `gridPrimary`                     | class/struct name |
| `src/fileInput/readElement.h`                                    |   40 | `gridSecondary`                   | class/struct name |
...
| `src/griddyn/GenModel.h`                      |   36 | `internalFrequencyCalculation`        | enum constant name |
| `src/griddyn/GenModel.h`                      |   37 | `atAngleLimits`                       | enum constant name |
