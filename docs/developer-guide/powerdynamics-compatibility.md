...
1. Use PowerDynamics' OpenIPSL-tested source and test structures to capture external trajectories for the implemented `GENCLS`, `GENSAL`, `GENROE`, and `ESST4B`, then create GridDyn P0 references for `GENSAE`, `SCRX`, and `ESST1A`.
