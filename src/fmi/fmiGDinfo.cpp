...
namespace griddyn {
static childTypeFactory<fmi::fmiMELoad, Load> fmild(
...
static childTypeFactory<fmi::fmiExciter, Exciter> fmiExciter(
...
static childTypeFactory<fmi::CymeDistLoadME, Load> cymeME(
