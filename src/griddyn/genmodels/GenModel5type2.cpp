...
// initial conditions
void GenModel5type2::dynObjectInitializeB(const IOdata& inputs,
                                ...
                                const solverMode& sMode)
{
    ...
    // Eqpp
    dv[4] =
        (-gmd[4] + gmd[3] + (Xdp - Xdpp + drat * (Xd - Xdp)) * gm[0] + Taa / Tdop * Eft) / Tdopp;
    // omega
...
stringVec GenModel5type2::localStateNames() const
{
