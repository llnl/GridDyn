...
class zmqProxyHub {
  public:
    ...
    void startProxy();
    void stopProxy();
    void modifyIncomingConnection(SocketOperation operation, const std::string& connection);
    void modifyOutgoingConnection(SocketOperation operation, const std::string& connection);
